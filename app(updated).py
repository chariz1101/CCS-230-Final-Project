...
if page == "Introduction":
    ...
    **Recommendation Logic:**
    ...
    title_query = st.text_input("Optional: Enter a Movie Title for Similar Recommendations")
    ...
    if st.button("Recommend"):
        ...
        recs = recommend_movies(genre_list=selected_genres if selected_genres else None,
                                user_id=uid,
                                title=title_query if title_query else None)
        if recs.empty:
            st.warning("No recommendations found. Try a different title or genre.")
        else:
